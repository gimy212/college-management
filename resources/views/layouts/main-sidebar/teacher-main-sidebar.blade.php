    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <center><img alt="user-img" class="avatar avatar-xl brround" src="{{ URL::asset('assets/images/R (2).png') }}" width="150" height="120"><span class="avatar-status profile-status bg-green"></span>
                </div>
